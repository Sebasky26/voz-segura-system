...
export default function ReglasPage() {
  ...
  const categoriasDisponibles = categorias.filter(
    (cat) => !reglas.some((r) => r.categoria === cat.value && r.activa)
  );
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Configura qué supervisor atiende cada categoría de denuncia
            </p>
          </div>
          <button
              ...
              <div>
                ...
                {categoriasDisponibles.length === 0 && (
                  <p className="text-xs text-gray-500 mt-1">
                    Todas las categorías tienen reglas activas
                  </p>
                )}
              </div>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ul className="text-sm text-blue-800 space-y-1">
            <li>• Solo puede haber una regla activa por categoría</li>
            <li>• Las denuncias se asignan automáticamente según estas reglas</li>
            <li>• Si no hay regla, se asigna por balance de carga</li>
            <li>• La prioridad determina qué regla se evalúa primero</li>
          </ul>
        </div>
      </div>
    </div>
